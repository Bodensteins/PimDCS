...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block: Type[Union[BasicBlock, Bottleneck]], channels: int, blocks: int,
        ...
        layers = [block(self.in_channels, channels, stride, down_sample, self.groups, self.base_width,

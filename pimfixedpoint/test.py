...
# ref_tensor = quantization.RefTensor(row_size, col_size, max_value, bit_width)
# ref_tensor.initialize_tensor(weight)
...
# input_tensor = quantization.NormalTensor(row_size, col_size, max_value, bit_width)
# input_tensor.initialize_tensor(input_mat)
...
PN_tensor.initialize_tensor(weight)

...
from config.globalCfg import TensorType, RightShiftMode, WeightUpdateStrategy, globalCfg
...
def fixed_point_matmul(input_tensor_tuple: tuple, other_tensor_tuple: tuple,
                       result_bit_width=globalCfg.dataFlowBitWidth):
...
def fixed_point_mul(tensor_tuple: tuple, alpha: float, alpha_bit_width: int = globalCfg.dataFlowBitWidth):
    int_tensor, quantization_para = _parse_tensor_tuple_to_int(tensor_tuple)
    s, tensor_type = _parse_quantization_para(quantization_para)
...
def fixed_point_mul_(tensor_tuple: tuple, alpha: float, alpha_bit_width: int = globalCfg.dataFlowBitWidth):
    int_tensor, quantization_para = _parse_tensor_tuple_to_int(tensor_tuple)
    _, tensor_type = _parse_quantization_para(quantization_para)

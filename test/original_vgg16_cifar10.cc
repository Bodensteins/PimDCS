...
struct VGG16_Net: torch::nn::Module
{
    VGG16_Net(): conv(13, nullptr), fc1(nullptr), fc2(nullptr), fc3(nullptr)
    {
        ...
        conv[2] = register_module("conv2", torch::nn::Conv2d(torch::nn::Conv2dOptions(64, 128, 3).padding(1)));
        conv[3] = register_module("conv3", torch::nn::Conv2d(torch::nn::Conv2dOptions(128, 128, 3).padding(1)));
        
        conv[4] = register_module("conv4", torch::nn::Conv2d(torch::nn::Conv2dOptions(128, 256, 3).padding(1)));
        conv[5] = register_module("conv5", torch::nn::Conv2d(torch::nn::Conv2dOptions(256, 256, 3).padding(1)));
        conv[6] = register_module("conv6", torch::nn::Conv2d(torch::nn::Conv2dOptions(256, 256, 3).padding(1)));
        
        conv[7] = register_module("conv7", torch::nn::Conv2d(torch::nn::Conv2dOptions(256, 512, 3).padding(1)));
        conv[8] = register_module("conv8", torch::nn::Conv2d(torch::nn::Conv2dOptions(512, 512, 3).padding(1)));
        conv[9] = register_module("conv9", torch::nn::Conv2d(torch::nn::Conv2dOptions(512, 512, 3).padding(1)));
        
        conv[10] = register_module("conv10", torch::nn::Conv2d(torch::nn::Conv2dOptions(512, 512, 3).padding(1)));
        conv[11] = register_module("conv11", torch::nn::Conv2d(torch::nn::Conv2dOptions(512, 512, 3).padding(1)));
        conv[12] = register_module("conv12", torch::nn::Conv2d(torch::nn::Conv2dOptions(512, 512, 3).padding(1)));
...
void mytest(std::shared_ptr<VGG16_Net> &net,
...
template<typename DataLoader>
void mytrain(std::shared_ptr<VGG16_Net> &net,
             DataLoader &data_loader,
             torch::Device device,
             size_t data_size,
             size_t batch_size,
...
{
    auto net = std::make_shared<VGG16_Net>();
    ...
    torch::optim::SGD optimizer(net->parameters(), /*lr=*/0.005);

...
auto fastmode = PIM::PIMRunMode::train_transientInBuffer;
...
struct Net: torch::nn::Module
{
    Net()
    {
        fc1 = register_module("fc1", PimLinear(784, 64, kTrainBatchSize, pim_type, fastmode, TensorOptions(torch::kF64).device(runDev)));
        fc2 = register_module("fc2", PimLinear(64, 10, kTrainBatchSize, pim_type, fastmode, TensorOptions(torch::kF64).device(runDev)));
    }
...
auto main(int argc, char *argv[]) -> int
{
    ...
    model.to(runDev, torch::kFloat64);

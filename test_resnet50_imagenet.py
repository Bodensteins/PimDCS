...
from examples.resnet_ou_model import resnet50_ou
...
def main():
    ...
    parser.add_argument('--weight-filename', default='PimResNet50_OU_ImageNet_checkpoint.pt', metavar='LF',
